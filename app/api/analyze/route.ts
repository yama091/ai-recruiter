...
function parseScoresFromContent(content: string): {
  ...
  const defaultMeta = {
    ...
    rank: "B",
    tier: "B",
    tierFeedback: "Solid foundation. Level up with more visible impact.",
  };
  if (jsonBlock) {
...
\`\`\`json
{"technical": 85, "contribution": 70, "sustainability": 80, "market": 75, "jobTitle": "Legendary Full-stack", "salaryDisplay": "12,345,678円", "rank": "A", "tier": "A", "tierFeedback": "Strong profile. One more open-source star or a visible side project would push you to S."}
\`\`\`
...
- tier: 厳格な格付け。S+（神クラス） / S / A / B / C / D / E（ジュニア）のいずれか1つ。スコアと実績に基づき甘くせず判定すること。
- tierFeedback: 英語で1文（辛口かつ的確なフィードバック）。SNSで反論や自慢したくなるような、具体的で刺さる一言。例: "You have the repos. Now get the stars." / "Senior title, junior visibility. Fix the latter."`;
